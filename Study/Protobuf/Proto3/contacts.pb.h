...
PROTOBUF_NAMESPACE_OPEN
template<> ::contacts3::Address* Arena::CreateMaybeMessage<::contacts3::Address>(Arena*);
template<> ::contacts3::Contacts* Arena::CreateMaybeMessage<::contacts3::Contacts>(Arena*);
template<> ::contacts3::PeopleInfo* Arena::CreateMaybeMessage<::contacts3::PeopleInfo>(Arena*);
template<> ::contacts3::PeopleInfo_Phone* Arena::CreateMaybeMessage<::contacts3::PeopleInfo_Phone>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace contacts3 {
...
class Address final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:contacts3.Address) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:contacts3.Address)
 private:
  class _Internal;
...
class PeopleInfo_Phone final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:contacts3.PeopleInfo.Phone) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "contacts3.PeopleInfo.Phone";
  }
  protected:
  ...
  // .contacts3.PeopleInfo.Phone.PhoneType type = 2;
  void clear_type();
  ::contacts3::PeopleInfo_Phone_PhoneType type() const;
  void set_type(::contacts3::PeopleInfo_Phone_PhoneType value);
  private:
  ::contacts3::PeopleInfo_Phone_PhoneType _internal_type() const;
  void _internal_set_type(::contacts3::PeopleInfo_Phone_PhoneType value);
  public:

  // @@protoc_insertion_point(class_scope:contacts3.PeopleInfo.Phone)
 private:
  class _Internal;
...
class PeopleInfo final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:contacts3.PeopleInfo) */ {
 public:
  ...
  // repeated .contacts3.PeopleInfo.Phone phone = 3;
  int phone_size() const;
  private:
  int _internal_phone_size() const;
  public:
  void clear_phone();
  ::contacts3::PeopleInfo_Phone* mutable_phone(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contacts3::PeopleInfo_Phone >*
      mutable_phone();
  private:
  const ::contacts3::PeopleInfo_Phone& _internal_phone(int index) const;
  ::contacts3::PeopleInfo_Phone* _internal_add_phone();
  public:
  const ::contacts3::PeopleInfo_Phone& phone(int index) const;
  ::contacts3::PeopleInfo_Phone* add_phone();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contacts3::PeopleInfo_Phone >&
      phone() const;
  ...
  // @@protoc_insertion_point(class_scope:contacts3.PeopleInfo)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contacts3::PeopleInfo_Phone > phone_;
...
class Contacts final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:contacts3.Contacts) */ {
 public:
  ...
  // repeated .contacts3.PeopleInfo contacts = 1;
  int contacts_size() const;
  private:
  int _internal_contacts_size() const;
  public:
  void clear_contacts();
  ::contacts3::PeopleInfo* mutable_contacts(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contacts3::PeopleInfo >*
      mutable_contacts();
  private:
  const ::contacts3::PeopleInfo& _internal_contacts(int index) const;
  ::contacts3::PeopleInfo* _internal_add_contacts();
  public:
  const ::contacts3::PeopleInfo& contacts(int index) const;
  ::contacts3::PeopleInfo* add_contacts();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contacts3::PeopleInfo >&
      contacts() const;

  // @@protoc_insertion_point(class_scope:contacts3.Contacts)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contacts3::PeopleInfo > contacts_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_contacts_2eproto;
...
inline const std::string& Address::home_address() const {
  // @@protoc_insertion_point(field_get:contacts3.Address.home_address)
...
void Address::set_home_address(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.home_address_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:contacts3.Address.home_address)
}
inline std::string* Address::mutable_home_address() {
  std::string* _s = _internal_mutable_home_address();
  // @@protoc_insertion_point(field_mutable:contacts3.Address.home_address)
  return _s;
}
...
inline std::string* Address::release_home_address() {
  // @@protoc_insertion_point(field_release:contacts3.Address.home_address)
...
inline void Address::set_allocated_home_address(std::string* home_address) {
  ...
  // @@protoc_insertion_point(field_set_allocated:contacts3.Address.home_address)
}
...
inline const std::string& Address::unit_address() const {
  // @@protoc_insertion_point(field_get:contacts3.Address.unit_address)
...
void Address::set_unit_address(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.unit_address_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:contacts3.Address.unit_address)
}
inline std::string* Address::mutable_unit_address() {
  std::string* _s = _internal_mutable_unit_address();
  // @@protoc_insertion_point(field_mutable:contacts3.Address.unit_address)
  return _s;
}
...
inline std::string* Address::release_unit_address() {
  // @@protoc_insertion_point(field_release:contacts3.Address.unit_address)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:contacts3.Address.unit_address)
}
...
inline const std::string& PeopleInfo_Phone::number() const {
  // @@protoc_insertion_point(field_get:contacts3.PeopleInfo.Phone.number)
...
void PeopleInfo_Phone::set_number(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.number_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:contacts3.PeopleInfo.Phone.number)
}
inline std::string* PeopleInfo_Phone::mutable_number() {
  std::string* _s = _internal_mutable_number();
  // @@protoc_insertion_point(field_mutable:contacts3.PeopleInfo.Phone.number)
  return _s;
}
...
inline std::string* PeopleInfo_Phone::release_number() {
  // @@protoc_insertion_point(field_release:contacts3.PeopleInfo.Phone.number)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:contacts3.PeopleInfo.Phone.number)
}
...
inline ::contacts3::PeopleInfo_Phone_PhoneType PeopleInfo_Phone::_internal_type() const {
  return static_cast< ::contacts3::PeopleInfo_Phone_PhoneType >(_impl_.type_);
}
inline ::contacts3::PeopleInfo_Phone_PhoneType PeopleInfo_Phone::type() const {
  // @@protoc_insertion_point(field_get:contacts3.PeopleInfo.Phone.type)
  return _internal_type();
}
inline void PeopleInfo_Phone::_internal_set_type(::contacts3::PeopleInfo_Phone_PhoneType value) {
  
  _impl_.type_ = value;
}
inline void PeopleInfo_Phone::set_type(::contacts3::PeopleInfo_Phone_PhoneType value) {
  _internal_set_type(value);
  // @@protoc_insertion_point(field_set:contacts3.PeopleInfo.Phone.type)
}
...
inline const std::string& PeopleInfo::name() const {
  // @@protoc_insertion_point(field_get:contacts3.PeopleInfo.name)
...
void PeopleInfo::set_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:contacts3.PeopleInfo.name)
}
inline std::string* PeopleInfo::mutable_name() {
  std::string* _s = _internal_mutable_name();
  // @@protoc_insertion_point(field_mutable:contacts3.PeopleInfo.name)
  return _s;
}
...
inline std::string* PeopleInfo::release_name() {
  // @@protoc_insertion_point(field_release:contacts3.PeopleInfo.name)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:contacts3.PeopleInfo.name)
}
...
inline int32_t PeopleInfo::age() const {
  // @@protoc_insertion_point(field_get:contacts3.PeopleInfo.age)
...
inline void PeopleInfo::set_age(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:contacts3.PeopleInfo.age)
}
...
inline ::contacts3::PeopleInfo_Phone* PeopleInfo::mutable_phone(int index) {
  // @@protoc_insertion_point(field_mutable:contacts3.PeopleInfo.phone)
  return _impl_.phone_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contacts3::PeopleInfo_Phone >*
PeopleInfo::mutable_phone() {
  // @@protoc_insertion_point(field_mutable_list:contacts3.PeopleInfo.phone)
  return &_impl_.phone_;
}
inline const ::contacts3::PeopleInfo_Phone& PeopleInfo::_internal_phone(int index) const {
  return _impl_.phone_.Get(index);
}
inline const ::contacts3::PeopleInfo_Phone& PeopleInfo::phone(int index) const {
  // @@protoc_insertion_point(field_get:contacts3.PeopleInfo.phone)
  return _internal_phone(index);
}
inline ::contacts3::PeopleInfo_Phone* PeopleInfo::_internal_add_phone() {
  return _impl_.phone_.Add();
}
inline ::contacts3::PeopleInfo_Phone* PeopleInfo::add_phone() {
  ::contacts3::PeopleInfo_Phone* _add = _internal_add_phone();
  // @@protoc_insertion_point(field_add:contacts3.PeopleInfo.phone)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contacts3::PeopleInfo_Phone >&
PeopleInfo::phone() const {
  // @@protoc_insertion_point(field_list:contacts3.PeopleInfo.phone)
  return _impl_.phone_;
}
...
inline const ::PROTOBUF_NAMESPACE_ID::Any& PeopleInfo::data() const {
  // @@protoc_insertion_point(field_get:contacts3.PeopleInfo.data)
...
inline void PeopleInfo::unsafe_arena_set_allocated_data(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:contacts3.PeopleInfo.data)
}
...
inline ::PROTOBUF_NAMESPACE_ID::Any* PeopleInfo::unsafe_arena_release_data() {
  // @@protoc_insertion_point(field_release:contacts3.PeopleInfo.data)
...
inline ::PROTOBUF_NAMESPACE_ID::Any* PeopleInfo::mutable_data() {
  ...
  // @@protoc_insertion_point(field_mutable:contacts3.PeopleInfo.data)
  return _msg;
}
inline void PeopleInfo::set_allocated_data(::PROTOBUF_NAMESPACE_ID::Any* data) {
  ...
  _impl_.data_ = data;
  // @@protoc_insertion_point(field_set_allocated:contacts3.PeopleInfo.data)
}
...
inline ::contacts3::PeopleInfo* Contacts::mutable_contacts(int index) {
  // @@protoc_insertion_point(field_mutable:contacts3.Contacts.contacts)
  return _impl_.contacts_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contacts3::PeopleInfo >*
Contacts::mutable_contacts() {
  // @@protoc_insertion_point(field_mutable_list:contacts3.Contacts.contacts)
  return &_impl_.contacts_;
}
inline const ::contacts3::PeopleInfo& Contacts::_internal_contacts(int index) const {
  return _impl_.contacts_.Get(index);
}
inline const ::contacts3::PeopleInfo& Contacts::contacts(int index) const {
  // @@protoc_insertion_point(field_get:contacts3.Contacts.contacts)
  return _internal_contacts(index);
}
inline ::contacts3::PeopleInfo* Contacts::_internal_add_contacts() {
  return _impl_.contacts_.Add();
}
inline ::contacts3::PeopleInfo* Contacts::add_contacts() {
  ::contacts3::PeopleInfo* _add = _internal_add_contacts();
  // @@protoc_insertion_point(field_add:contacts3.Contacts.contacts)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::contacts3::PeopleInfo >&
Contacts::contacts() const {
  // @@protoc_insertion_point(field_list:contacts3.Contacts.contacts)
  return _impl_.contacts_;
}
...
template <> struct is_proto_enum< ::contacts3::PeopleInfo_Phone_PhoneType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::contacts3::PeopleInfo_Phone_PhoneType>() {
  return ::contacts3::PeopleInfo_Phone_PhoneType_descriptor();
}
